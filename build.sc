...
object `chisel-circt-binder`
  extends common.ChiselCIRCTPanamaBinderModule { m =>
  // TODO: find path from nix+env
  def includePath = T(PathRef(os.root))
  def libraryPath = T(PathRef(os.root))
  ...
  object tests extends TestModule with TestModule.Utest with common.HasChiselCIRCTPanamaBinderModule {
